...
export const SOURCE_PROVIDER_REGISTRY: SourceProviderDefinition[] = [
  ...
  // Phase 3 Africa pack providers
  {
    id: "nimet-weather",
    name: "NiMet Weather (Nigerian Meteorological Agency)",
    ...
    priority: 10,
    freshness: "Real-time weather; 6-hour forecast updates",
    reliability: "High; official Nigerian Meteorological Agency",
    rateLimit: "Public API, cache 6 hours",
    notes: "Real-time weather observations and monsoon/drought alerts from 36 meteorological subdivisions across Nigeria.",
    integrated: false,
    resolution: "Subdivision-level (36 subdivisions)",
    updateCadence: "continuous",
  },
  {
    id: "kmd-weather",
    name: "KMD Weather & Drought Monitoring (Kenya Meteorological Department)",
    url: "https://meteo.go.ke/",
    domains: ["weather"],
    accessType: "api",
    coverage: ["africa"],
    priority: 10,
    freshness: "Real-time weather; ENACTS drought monitoring (dekadal)",
    reliability: "High; official Kenya Meteorological Department + CGIAR ENACTS program",
    rateLimit: "Public API, cache 6 hours",
    notes: "Real-time weather observations and drought status from Kenya KMD, Enhanced National Climate Services (ENACTS) project.",
    integrated: false,
    resolution: "Station/County-level monitoring",
    updateCadence: "continuous",
  },
  {
    id: "sa-seismic-hazards",
    name: "South Africa Seismic Hazards (GEM & Council for Geoscience)",
    url: "https://www.globalquakemodel.org/",
    domains: ["hazards"],
    accessType: "api",
    coverage: ["africa"],
    priority: 10,
    freshness: "Static hazard model (5-year updates); real-time earthquake catalog",
    reliability: "Very high; official GEM probabilistic hazard model + Council for Geoscience",
    rateLimit: "Open access (CC-BY 3.0), cache 12 hours",
    notes: "Probabilistic seismic hazard assessment (PGA) for South Africa with real-time earthquake locations from Council for Geoscience network.",
    integrated: false,
    resolution: "~5 km hazard grid, event-level earthquake data",
    updateCadence: "periodic",
  },
  {
    id: "gem-africa-seismic",
    name: "GEM Africa Seismic Hazard Mosaic (Sub-Saharan Africa)",
    url: "https://www.globalquakemodel.org/",
    domains: ["hazards"],
    accessType: "api",
    coverage: ["africa"],
    priority: 10,
    freshness: "Static hazard models (periodic updates); real-time USGS earthquake catalog",
    reliability: "High; GEM Open Quake platform + international earthquake networks",
    rateLimit: "Open access (CC-BY 3.0), cache 12 hours",
    notes: "GEM probabilistic seismic hazard models covering Sub-Saharan Africa (SSA), West Africa (WAF), East Africa (EAF) regions. Integrates USGS and national earthquake catalogs.",
    integrated: false,
    resolution: "~10 km hazard grid, event-level earthquake data",
    updateCadence: "periodic",
  },
  // Phase 3 Southeast Asia pack providers
  {
    id: "bmkg-indonesia",
    name: "BMKG Weather & Seismic (Indonesia)",
    url: "https://data.bmkg.go.id/",
    domains: ["weather", "hazards"],
    accessType: "api",
    coverage: ["southeast-asia"],
    priority: 10,
    freshness: "Real-time weather (hourly); seismic data continuous; tsunami warnings real-time",
    reliability: "Very high; official Indonesian Meteorological, Climatological & Geophysical Agency",
    rateLimit: "Public API, cache 6 hours",
    notes: "Real-time weather and 400+ seismic sensors covering Indonesia's Ring of Fire. Tsunami warning system integrated (INATEWS).",
    integrated: false,
    resolution: "Station/grid-level weather; event-level seismic data",
    updateCadence: "continuous",
  },
  {
    id: "tmd-weather",
    name: "TMD Weather Observations (Thailand Meteorological Department)",
    url: "https://tmd.go.th/",
    domains: ["weather"],
    accessType: "api",
    coverage: ["southeast-asia"],
    priority: 10,
    freshness: "Real-time weather; 6-hour forecast updates",
    reliability: "High; official Thailand Meteorological Department AWS network",
    rateLimit: "Public API, cache 6 hours",
    notes: "Real-time weather observations from 50+ automated weather stations (AWS) across Thailand; monsoon and heat-wave alerts.",
    integrated: false,
    resolution: "Station-level (~50 stations distributed nationwide)",
    updateCadence: "continuous",
  },
  {
    id: "nchmf-weather",
    name: "NCHMF Weather & Hydrology (Vietnam)",
    url: "https://hymetdata.gov.vn/",
    domains: ["weather", "hydrology"],
    accessType: "api",
    coverage: ["southeast-asia"],
    priority: 10,
    freshness: "Daily weather forecasts; real-time rainfall observations",
    reliability: "High; official Vietnam National Center for Hydro-Meteorological Forecasting",
    rateLimit: "Public data, cache 6 hours",
    notes: "Real-time weather, rainfall, and hydrological forecasts from 172+ meteorological stations across Vietnam.",
    integrated: false,
    resolution: "Station-level (172 stations), basin-level hydrology",
    updateCadence: "daily",
  },
  {
    id: "asmc-weather",
    name: "ASMC Regional Weather & ENSO (Southeast Asia)",
    url: "https://asmc.asean.org/",
    domains: ["weather"],
    accessType: "api",
    coverage: ["southeast-asia"],
    priority: 10,
    freshness: "Real-time regional observations; monthly seasonal outlooks; ENSO forecasts",
    reliability: "High; ASEAN Specialized Meteorological Centre coordination of 10 national services",
    rateLimit: "Public API, cache 12 hours",
    notes: "Regional SE Asia weather coordination, haze monitoring, seasonal rainfall forecasts, ENSO outlooks covering all 10 ASEAN member states.",
    integrated: false,
    resolution: "Regional (ASEAN-wide coordination)",
    updateCadence: "continuous",
  },
];
