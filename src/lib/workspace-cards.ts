...
const WORKSPACE_CARD_REGISTRY_BASE = [
  ...
  },
  {
    ...
    summary: "Metro-level residential market context: median sale price, days on market, and inventory trends.",
    questionAnswered: "What is the residential market doing near this location?",
    regionCoverage: "US metro areas — falls back to unavailable for non-US or rural points",
    failureMode: "Shows unavailability message when outside coverage; degrades gracefully on API timeout",
    freshnessWindow: "Live on location change",
    nextActions: ["Compare market conditions across saved sites", "Check school context for residential fit", "Open demographics for population context"],
    icon: "Home",
    category: "context",
    zone: "workspace",
    emphasis: "secondary",
    ...
    defaultOrder: 55,
    requiredData: [],
    supportedProfiles: ["residential", "home-buying"],
    emptyState: "Select a US location to see residential market context.",
  },
  {
    id: "hazard-context",
  ...
  {
    id: "multi-hazard-resilience",
    title: "Multi-hazard resilience",
    summary: "Compound resilience score across seismic, flood, fire, air quality, contamination, and disaster alerts.",
    questionAnswered: "How does this place stack up across all major hazard domains at once?",
    regionCoverage: "Global for fire, air quality, and alerts — US-only for seismic design, flood zone, and contamination",
    failureMode: "Non-US locations show unavailable for seismic, flood, and contamination domains; compound score uses available signals",
    freshnessWindow: "Live — pulls from the same hazard feeds as individual hazard cards",
    nextActions: ["Drill into individual hazard cards", "Compare compound score across saved sites", "Review source trust panel"],
    icon: "ShieldAlert",
    category: "planning",
    zone: "workspace",
    emphasis: "secondary",
    ...
    defaultOrder: 127,
    requiredData: ["geodata"],
    supportedProfiles: ["data-center", "home-buying", "site-development", "commercial", "hiking"],
    emptyState: "Select a location to build the multi-hazard resilience summary.",
  },
  {
    id: "resilience-score",
    title: "Hazard resilience",
    summary: "Composite multi-hazard resilience score across flood, seismic, fire, contamination, and air quality.",
    questionAnswered: "How resilient is this location across the major environmental hazard domains?",
    regionCoverage: "US-primary; flood, seismic, and air quality have global fallbacks",
    failureMode: "Individual domain scores degrade to 'unknown' when source data is missing",
    freshnessWindow: "Recomputed on geodata change",
    nextActions: ["Inspect source data for each domain", "Compare resilience across saved sites"],
    icon: "ShieldCheck",
    category: "planning",
    zone: "workspace",
    emphasis: "secondary",
    ...
    defaultVisibility: false,
    defaultOrder: 310,
    requiredData: [] as const,
    supportedProfiles: ["data-center", "hiking", "residential", "commercial"],
    emptyState: "Search a location to see the multi-hazard resilience score.",
  },
  {
    id: "hazard-details",
    title: "Hazard parameters",
    summary: "Raw seismic, flood, fire, and disaster event data for analyst-level review.",
    questionAnswered: "What are the exact technical hazard parameters for this location?",
    regionCoverage: "Global for fire/alerts/air quality; US-only for seismic design and FEMA flood zones",
    failureMode: "Unavailable domains shown with explicit coverage notes; US-only data labeled",
    freshnessWindow: "Live on location change",
    nextActions: ["Cross-reference with Multi-hazard resilience score", "Open source awareness to check data status"],
    icon: "FileSearch",
    category: "planning",
    zone: "workspace",
    emphasis: "secondary",
...
const EXPLORER_ONLY_CARDS: WorkspaceCardDefinition[] = [
  ...
  },
  {
    ...
    summary: "Go/caution/risk screen across road access, power grid, broadband, flood exposure, soil drainage, and seismic site class.",
    questionAnswered: "What are the key infrastructure and hazard constraints for developing this site?",
    regionCoverage: "Road and power global via OSM. Broadband US (FCC) or Eurostat baseline. Flood, soil, seismic US only.",
    failureMode: "Non-US locations show unavailable for flood, soil, and seismic signals; road/power/broadband still populate",
    freshnessWindow: "Recomputed on location change from live geodata bundle",
    nextActions: [
      "Drill into flood risk card for FEMA detail",
      "Open soil profile for SSURGO data",
      "Check seismic design card for ASCE 7-22 values",
    ],
    icon: "ClipboardCheck",
    category: "planning",
    zone: "workspace",
    ...
    summaryVariant: "Six-signal go/caution/risk screen for site development.",
    compactActions: ["Open flood risk card", "Check seismic design"],
    densityBudget: "medium",
    audience: "both",
    complexity: "simple",
    modeVisibility: { explorer: false, pro: true },
  },
  {
    id: "infrastructure-access",
    title: "Infrastructure access",
    summary: "Raw proximity measurements to road, power grid, water body, and broadband for this location.",
    questionAnswered: "How far is this site from the four key infrastructure inputs — road, power, water, and broadband?",
    regionCoverage: "Road, power, water global via OSM. Broadband US (FCC) or Eurostat baseline.",
    failureMode: "Shows no-data for sources that did not return results; distances are straight-line, not routed",
    freshnessWindow: "Recomputed on location change from live geodata bundle",
    nextActions: [
      "Open site readiness for a scored summary",
      "Check broadband card for provider detail",
      "Review cooling water for surface water specifics",
    ],
    icon: "Cable",
    category: "planning",
    zone: "workspace",
    ...
    revealTier: "supporting",
    revealTriggers: ["location_selected", "ask_reasoning"],
    summaryVariant: "Raw distances to road, power, water, and broadband.",
    compactActions: ["Open site readiness", "Check broadband card"],
    densityBudget: "medium",
    audience: "both",
    complexity: "simple",
    modeVisibility: { explorer: false, pro: true },
  },
  {
    id: "local-access",
    title: "Local access",
    summary: "Derived walkability proxy score from OSM-mapped amenity density — transit, food, commercial, and healthcare.",
    questionAnswered: "How walkable and service-rich is this location based on mapped amenities?",
    regionCoverage: "Global where OpenStreetMap coverage is sufficient",
    failureMode: "Score will read low in areas with sparse OSM data regardless of true density",
    freshnessWindow: "Recomputed on location change from live OSM data",
    nextActions: [
      "Open local access for a walkability breakdown",
      "Check nearby places for destination-level detail",
      "Open demographics context for population density",
    ],
    icon: "MapPin",
    category: "analysis",
    zone: "workspace",
    ...
    requiredData: ["geodata"],
    supportedProfiles: ["data-center", "hiking", "residential", "commercial"],
    emptyState: "Select a location to see the local access score.",
    revealTier: "supporting",
    revealTriggers: ["location_selected", "ask_reasoning"],
    summaryVariant: "Proxy walkability score from transit, food, commercial, and healthcare density.",
    compactActions: ["Check nearby places", "Open demographics"],
    densityBudget: "medium",
    audience: "public",
    complexity: "simple",
    explorerLabel: "Local access",
    explorerSummary: "How walkable is this location?",
    modeVisibility: { explorer: true, pro: true },
  },
];
