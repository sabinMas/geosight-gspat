            ...
            <div ref={explorerStep2Ref} className="mx-auto max-w-xl">
              ...
              >
                ...
                <div className={`flex gap-3 transition-opacity duration-200 ${selectedUseCaseId?.startsWith("explorer-") ? "opacity-100" : "opacity-50"}`}>
                  <Button type="submit" data-walkthrough="landing-explore-button" className="h-12 flex-1 rounded-full" disabled={submitting || !selectedUseCaseId?.startsWith("explorer-")}>
