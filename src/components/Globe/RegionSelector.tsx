...
export function RegionSelector({
  ...
  return (
    <div className="absolute bottom-4 left-4 z-10 max-w-[320px] rounded-[1.75rem] border border-[color:var(--border-soft)] bg-[var(--surface-panel)] p-3.5 shadow-[var(--shadow-panel)] backdrop-blur-lg text-sm text-[var(--foreground-soft)] animate-in fade-in slide-in-from-bottom-2 duration-200">
