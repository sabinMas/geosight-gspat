...
export function GlobeViewSelector({
  ...
  return (
    <div ref={rootRef} className="absolute left-4 top-4 z-40">
      {globeViewOpen ? (
        <button
          type="button"
      ...
      <div className="relative z-10">
        ...
        {globeViewOpen ? (
          <div
            ...
            className="absolute left-0 top-14 z-30 w-[320px] rounded-[1.75rem] border border-[color:var(--border-soft)] bg-[var(--surface-panel)] p-4 shadow-[var(--shadow-panel)] backdrop-blur-lg animate-in fade-in slide-in-from-top-2 duration-200"
          >
