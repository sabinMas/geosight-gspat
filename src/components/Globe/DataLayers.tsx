  ...
  return (
    <div ref={rootRef} className="absolute right-4 top-4 z-20">
      <div className="relative">
        {open ? (
          <div
            className="absolute right-0 top-14 z-10 max-h-[70vh] w-[320px] overflow-y-auto rounded-[1.75rem] border border-[color:var(--border-soft)] bg-[var(--surface-panel)] p-4 shadow-[var(--shadow-panel)] backdrop-blur-lg scrollbar-thin animate-in fade-in slide-in-from-top-2 duration-200"
            role="region"
